...
<section className="relative overflow-hidden py-16 md:py-24 bg-background transition-colors duration-300">
  ...
  <svg className="absolute top-12 left-0 w-40 h-64 opacity-[0.08] dark:opacity-[0.15] pointer-events-none text-foreground dark:text-primary" viewBox="0 0 100 200">
  ...
  <svg className="absolute bottom-12 right-0 w-40 h-64 opacity-[0.08] dark:opacity-[0.15] pointer-events-none rotate-180 text-foreground dark:text-primary" viewBox="0 0 100 200">
    <path d="M90 0 L20 100 L95 200" stroke="currentColor" strokeWidth="3" fill="none" strokeDasharray="12 6"/>
    <path d="M70 30 L10 100 L75 170" stroke="currentColor" strokeWidth="2" fill="none" strokeDasharray="8 8"/>
  </svg>
  ...
  <div className="container relative z-10 mx-auto max-w-2xl px-4 py-14">
    ...
    <div className="mb-10 flex items-center gap-4">
      <div className="relative">
        <h2 className="font-bangers text-4xl text-foreground dark:text-white sm:text-5xl md:text-6xl tracking-wide relative inline-block"
          style={{ 
    ...
    {/* Comic Form Panel */}
    <div className="relative bg-card dark:bg-card border-4 border-foreground dark:border-primary p-6 md:p-10 shadow-[10px_10px_0px_0px_rgba(0,0,0,1)] dark:shadow-[10px_10px_0px_0px_var(--color-primary)]">
      {/* Inner dashed border */}
      <div className="absolute inset-3 border-2 border-dashed border-gray-200 dark:border-gray-800 pointer-events-none"/>
      
      {/* Corner accents */}
      <div className="absolute -top-3 -left-3 w-8 h-8 bg-primary border-3 border-foreground z-10"/>
      <div className="absolute -bottom-3 -right-3 w-8 h-8 bg-accent border-3 border-foreground z-10"/>
      ...
      <AnimatePresence>
        {feedbackSent && (
          <motion.div
            ...
            className="absolute inset-0 z-20 flex flex-col items-center justify-center gap-4 bg-card/98 dark:bg-card/98 p-8 text-center border-4 border-foreground dark:border-primary m-4 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]"
          >
      ...
      <form onSubmit={handleFeedback} className="relative z-10 flex flex-col gap-6">
        ...
        <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
          <div className="relative">
            <label className="mb-2 inline-block bg-primary px-3 py-1 font-oswald text-xs font-bold uppercase tracking-wider text-white border-2 border-foreground shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]">
              Name
            </label>
            <input
              type="text"
        ...
        <div className="relative">
          ...
          <textarea
            ...
            rows={5}
            required
            className="w-full resize-none bg-muted dark:bg-background border-3 border-foreground dark:border-primary px-4 py-3 font-oswald text-base text-foreground dark:text-white placeholder:text-gray-400 dark:placeholder:text-gray-600 focus:border-accent dark:focus:border-accent focus:outline-none focus:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] dark:focus:shadow-[4px_4px_0px_0px_var(--color-primary)] transition-all shadow-[3px_3px_0px_0px_rgba(0,0,0,0.1)]"
      ...
      {/* Decorative elements */}
      <div className="absolute -top-6 right-8 bg-primary dark:bg-primary border-3 border-foreground px-3 py-1 font-bangers text-sm text-foreground shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] rotate-12 z-20">
        WRITE TO US!
      </div>
      
      <div className="absolute -bottom-4 left-8 bg-primary border-3 border-foreground px-3 py-1 font-bangers text-sm text-white shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] -rotate-6 z-20">
        WE LISTEN!
      </div>
    </div>
  </div>
